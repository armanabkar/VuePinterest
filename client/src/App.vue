<template>
  <v-app style="background: #e3e3ee">
    ...
    <v-navigation-drawer app temporary fixed v-model="sideNav">
      <v-toolbar color="white" flat>
        ...
        <router-link to="/" tag="span" style="cursor: pointer">
          <h1 class="title pl-3">VuePinterest</h1>
        </router-link>
      </v-toolbar>
      ...
      <v-list>
        ...
        <!-- Search Button -->
        <v-list-tile @click="handleSearchButton">
          <v-list-tile-action>
    ...
    <!-- Horizontal Navbar -->
    <v-toolbar fixed color="white" v-clickOutside="toggleSearch">
      <!-- App Title -->
      <v-toolbar-side-icon @click="toggleSideNav"></v-toolbar-side-icon>
      <v-toolbar-title>
        <router-link
      ...
      <v-toolbar-items class="hidden-xs-only">
        ...
        <!-- Search Button -->
        <v-btn flat @click="handleSearchButton">
          <v-icon class="hidden-sm-only" left>search</v-icon>
          <v-badge
            right
            color="blue darken-2"
